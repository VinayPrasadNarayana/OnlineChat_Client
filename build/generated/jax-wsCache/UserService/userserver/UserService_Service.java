 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://UserServer/", wsdlLocation = "http://localhost:8080/OnlineChatServer/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://UserServer/", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/OnlineChatServer/UserService?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://UserServer/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://UserServer/", "UserServicePort"), UserService.class, features);
    }
